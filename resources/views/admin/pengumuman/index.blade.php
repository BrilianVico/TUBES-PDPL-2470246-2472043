...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Custom Tombol Aksi Tabel agar Senada */
        .btn-edit-custom {
            background: #d4d44d;
            color: #4a4a0e;
            border: none;
        ...
        /* Custom Status Badge agar Selaras */
        .bg-success { background-color: #166534 !important; }
        .bg-warning { background-color: #bfa524 !important; color: white !important; }
...
<div class="content">
    ...
    <div class="card-box">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.pengumuman.create') }}" class="btn btn-primary-custom">
                + Tambah Pengumuman
            </a>
        </div>
            ...
            <table class="table align-middle">
                ...
                @forelse($pengumuman as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.pengumuman.edit', $item->id_pengumuman) }}" class="btn btn-edit-custom">
                                Edit
                            </a>

                            <form action="{{ route('admin.pengumuman.destroy', $item->id_pengumuman) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus pengumuman ini?')">
                                @csrf
                                @method('DELETE')
