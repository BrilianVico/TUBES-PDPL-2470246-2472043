...
<head>
    ...
    <title>Tambah Pengumuman - SMP Sunodia</title>
...
<div class="content">
    ...
    <div class="topbar">
        ...
        <p>Buat pengumuman yang akan tampil pada dashboard orang tua.</p>
    </div>
        ...
        <form action="{{ route('admin.pengumuman.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="date" name="tanggal_selesai" class="form-control" value="{{ old('tanggal_selesai') }}" readonly style="background-color: #e2e8f0; cursor: not-allowed;">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="target" id="target" class="form-select" required>
                    <option value="Semua Orang Tua" {{ old('target') == 'Semua Orang Tua' ? 'selected' : '' }}>Semua Orang Tua</option>
                    <option value="Kelas Tertentu" {{ old('target') == 'Kelas Tertentu' ? 'selected' : '' }}>Kelas Tertentu</option>
                    <option value="Siswa Tertentu" {{ old('target') == 'Siswa Tertentu' ? 'selected' : '' }}>Siswa Tertentu</option>
                </select>
            </div>
            ...
            <div class="mb-4" id="kelas-container" style="display: none;">
                ...
                <select name="kelas_target" class="form-select">
                    ...
                    @foreach($kelas as $item)
                        <option value="{{ $item->nama_kelas }}" {{ old('kelas_target') == $item->nama_kelas ? 'selected' : '' }}>
                            {{ $item->nama_kelas }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-4" id="siswa-container" style="display: none;">
                ...
                <select name="id_siswa_target" class="form-select">
                    ...
                    @foreach($siswa as $item)
                        <option value="{{ $item->id_siswa }}" {{ old('id_siswa_target') == $item->id_siswa ? 'selected' : '' }}>
                            {{ $item->nis }} - {{ $item->nama }}
                        </option>
                    @endforeach
                </select>
