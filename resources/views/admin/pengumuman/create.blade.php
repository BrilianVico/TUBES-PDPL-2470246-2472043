            ...
            <div class="mb-4">
                ...
                <select name="target"
                    ...
                    <option value="Semua Orang Tua"
                        {{ old('target') == 'Semua Orang Tua' ? 'selected' : '' }}>
                        Semua Orang Tua
                    </option>
                    <option value="Kelas Tertentu"
                        {{ old('target') == 'Kelas Tertentu' ? 'selected' : '' }}>
                        Kelas Tertentu
                    </option>
                    <option value="Siswa Tertentu"
                        {{ old('target') == 'Siswa Tertentu' ? 'selected' : '' }}>
                        Siswa Tertentu
                    </option>
                </select>
            </div>
                ...
                <select name="kelas_target" class="form-select">
                    ...
                    @foreach($kelas as $item)
                        <option value="{{ $item->nama_kelas }}"
                            {{ old('kelas_target') == $item->nama_kelas ? 'selected' : '' }}>
                            {{ $item->nama_kelas }}
                        </option>
                    @endforeach
                </select>
                ...
                <select name="id_siswa_target" class="form-select">
                    ...
                    @foreach($siswa as $item)
                        <option value="{{ $item->id_siswa }}"
                            {{ old('id_siswa_target') == $item->id_siswa ? 'selected' : '' }}>
                            {{ $item->nis }} - {{ $item->nama }}
                        </option>
                    @endforeach
                </select>
