    ...
    <div class="card-box">
        <form action="{{ route('admin.tagihan.store') }}" method="POST">
            ...
            <div class="mb-4" id="siswaWrapper" style="display:none;">
                ...
                <select name="id_siswa" id="idSiswaSelect" class="form-select">
            ...
            <div class="mb-4">
                ...
                <select name="jenis_tagihan" id="jenisTagihan" class="form-select" required>
            ...
            <div class="mb-4" id="semesterWrapper" style="display:none;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" id="btnGenerate" class="btn btn-primary-custom">Generate Tagihan</button>
            </div>
        </form>
    </div>
...
<script>
    ...
    const jenisTagihan = document.getElementById('jenisTagihan');
    const idSiswaSelect = document.getElementById('idSiswaSelect');

    // Inisialisasi DOM Dropdown Semester
    ...
    function toggleSiswa() {
        if (modeSatu.checked) {
            ...
            idSiswaSelect.setAttribute('required', 'required');
        } else {
            siswaWrapper.style.display = 'none';
            idSiswaSelect.removeAttribute('required');
            idSiswaSelect.value = '';
        }
    }

    function cekJenisTagihan() {
        const jenis = jenisTagihan.value;

        if (
            jenis === 'Buku' ||
            jenis === 'Seragam'
        ) {
            modeSatu.checked = true;
            modeSemua.disabled = true;
        } else {
            modeSemua.disabled = false;
        }

        // Dropdown Semester otomatis muncul jika jenis Pembangunan dipilih
    ...
    jenisTagihan.addEventListener('change', cekJenisTagihan);
