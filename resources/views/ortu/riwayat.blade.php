...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="{{ route('ortu.riwayat.index') }}" class="active">
                Riwayat Pembayaran
            </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="table-card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                    <h5 class="fw-bold mb-0 text-secondary">Daftar Transaksi</h5>
                    <form method="GET" action="{{ route('ortu.riwayat.index') }}" class="d-flex align-items-center gap-2">
                        <label for="jenis" class="text-muted small fw-semibold mb-0">Filter:</label>
                        <select name="jenis" id="jenis" class="form-select form-select-sm rounded-3 border-secondary-subtle" style="min-width: 180px;" onchange="this.form.submit()">
                            ...
                            <option value="Pembangunan" {{ request('jenis') == 'Pembangunan' ? 'selected' : '' }}>Pembangunan</option>
                    ...
                    <table class="table align-middle">
                        ...
                        @forelse($riwayat as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <span class="fw-semibold">{{ $item->jenis_tagihan }}</span>
                                    <br>
                                    <small class="text-muted">{{ $item->bulan }} {{ $item->tahun }}</small>
                                </td>
                                ...
                                <td>
                                    ...
                                    @elseif($item->status_bayar == 'DITOLAK')
                                        <span class="badge-danger-custom">Ditolak</span>
                                    @else
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">
                                    Belum ada riwayat pembayaran untuk jenis ini.
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
